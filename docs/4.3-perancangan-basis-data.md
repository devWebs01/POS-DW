...
Perancangan basis data merupakan tahapan untuk mendefinisikan struktur data yang akan digunakan oleh sistem. Perancangan basis data yang baik sangat penting untuk menjamin integritas data, menghindari redundansi, dan memastikan performa sistem yang optimal. Dalam perancangan sistem POS DW, basis data dirancang menggunakan Entity Relationship Diagram (ERD) untuk memodelkan hubungan antar data, dilanjutkan dengan perancangan struktur tabel yang akan diimplementasikan pada database management system.
...
**Tabel 4.20 Daftar Entitas Database**
...
| 2 | roles | Master | Menyimpan data role/peran pengguna (Admin, Kasir, Manager) | 4 |
...
**Tabel 4.21 Relasi Antar Entitas**
...
**Tabel 4.22 Struktur Tabel users**
...
**Tabel 4.23 Struktur Tabel roles**

| Field | Type | Length | Null | Key | Default | Extra | Keterangan |
|-------|------|--------|------|-----|---------|-------|------------|
| id | BIGINT UNSIGNED | - | NO | PRI | NULL | auto_increment | Primary key |
| name | VARCHAR | 255 | NO | - | NULL | - | Nama role (contoh: Admin, Kasir, Manager) |
| guard_name | VARCHAR | 255 | NO | - | NULL | - | Nama guard (default: web) |
| created_at | TIMESTAMP | - | YES | - | NULL | - | Waktu data dibuat |
| updated_at | TIMESTAMP | - | YES | - | NULL | - | Waktu data diupdate |

**Tabel 4.24 Struktur Tabel permissions**
...
**Tabel 4.25 Struktur Tabel model_has_roles (Pivot)**
...
**Tabel 4.26 Struktur Tabel role_has_permissions (Pivot)**
...
**Tabel 4.27 Struktur Tabel categories**
...
**Tabel 4.28 Struktur Tabel products**
...
**Tabel 4.29 Struktur Tabel transactions**
...
**Tabel 4.30 Struktur Tabel transaction_items**
...
**Tabel 4.31 Struktur Tabel sessions**
...
**Tabel 4.32 Struktur Tabel settings**
...
**Tabel 4.33 Struktur Tabel cache**
...
**Tabel 4.34 Struktur Tabel jobs**
...
Perancangan basis data yang telah dijelaskan pada sub-bab ini mencakup dua aspek utama:

1. **Entity Relationship Diagram (ERD)** menggambarkan 11 entitas yang saling berelasi dalam sistem POS DW, meliputi entitas master (users, roles, permissions, categories), transaksi (products, transactions, transaction_items), pivot (model_has_roles, role_has_permissions), dan sistem (sessions, settings). Relasi antar entitas terdiri dari one-to-many dan many-to-many dengan kardinalitas yang telah didefinisikan secara jelas.

2. **Struktur Tabel Database** mendefinisikan detail 13 tabel database yang terdiri dari tipe data, panjang field, konstrain (primary key, foreign key, unique), default value, dan index. Setiap tabel telah dilengkapi dengan strategi indexing untuk mengoptimalkan performa query pada kolom-kolom yang sering diakses.

Perancangan basis data ini telah mempertimbangkan aspek normalisasi data untuk menghindari redundansi, integritas referensial melalui foreign key, dan performa query melalui indeks yang tepat pada kolom-kolom yang sering diakses.

---

## Navigasi

| [← Daftar Isi](./README.md) | [← 4.2 Analisis Proses Sistem](./4.2-perancangan-sistem.md) | [4.4 Perancangan Antarmuka →](./4.4-perancangan-antarmuka.md) |
|:---:|:---:|:---:|
