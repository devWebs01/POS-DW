...
flowchart TD
  ...
  S_D --> S_E["Sist
em: Tampilkan notifikasi sukses"]
...
flowchart TD
  ...
  D_A -->|Tidak| E_A["Sistem: Tampilkan error validasi"]
  E_A --> A_D
  D_A -->|Ya| S_D["Sistem: Update katego
ri di database"]
...
flowchart TD
  ...
  start --> A_A
  S_A["Sistem: Tampilkan halaman da
ftar role"]
  A_A --> S_A
...
flowchart TD
  ...
  S_B --> A_C
  A_D["Admin: Pilih filter kategori/produk (o
psional)"]
  A_C --> A_D
