...
2. **Use Case Diagram** mengidentifikasi tiga aktor (Admin, Kasir, Manager) dengan 23 use case yang mencakup seluruh fungsionalitas sistem. Setiap use case telah dijelaskan secara detail termasuk aliran utama dan alternatif.
...
**Navigasi:**
- [← Kembali ke 4.1 Analisis Kebutuhan Sistem](./4.1-analisis-kebutuhan-sistem.md)
- [Lanjut ke 4.3 Perancangan Basis Data →](./4.3-perancangan-basis-data.md)
