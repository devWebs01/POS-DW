...
| **ID Use Case** | UC-04 |
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan pengolahan data kategori produk |
...
| 3. Actor memilih tombol untuk mengelola kategori |
| * Actor memilih Tambah, maka S1 yang berlaku |
| * Actor memilih Edit, maka S2 yang berlaku |
| * Actor memilih Hapus, maka S3 yang berlaku |
...
| 7. Actor kembali menginput data kategori |
...
| Post Condition |
|----------------|
| Actor berhasil melakukan pengolahan data kategori |
...
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan pengolahan data produk dan mengunggah gambar produk |
| **Exception** | Pengolahan data gagal dikarenakan data belum lengkap atau format gambar tidak sesuai |
| **Precondition** | Actor telah login ke dalam sistem dan data kategori sudah tersedia |

| Aktor | Sistem |
|-------|--------|
| 1. Pilih menu Produk | |
| | 2. Tampilkan halaman daftar produk |
| 3. Actor memilih tombol untuk mengelola produk |
| * Actor memilih Tambah, maka S1 yang berlaku |
| * Actor memilih Edit, maka S2 yang berlaku |
| * Actor memilih Hapus, maka S3 yang berlaku |
...
| 8. Actor kembali menginput data produk |
...
| Post Condition |
|----------------|
| Actor berhasil melakukan pengolahan data produk |
...
| **ID Use Case** | UC-07 |
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan penyesuaian stok produk secara manual |
| **Exception** | Data stok gagal diperbarui karena data tidak valid |
| **Precondition** | Actor telah login ke dalam sistem dan data produk tersedia |
...
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan proses transaksi penjualan produk kepada customer melalui interface Point of Sale, dimulai dari pemilihan produk, input pembayaran, hingga mencetak struk |
| **Exception** | Transaksi gagal karena stok tidak mencukupi atau pembayaran kurang |
| **Precondition** | Actor telah login ke dalam sistem dan minimal ada satu produk aktif dengan stok tersedia |
...
| Post Condition |
|----------------|
| Actor berhasil melakukan transaksi penjualan, data tersimpan, stok berkurang, dan struk siap dicetak |
...
| **ID Use Case** | UC-12 |
| **Aktor** | Admin dan Pemilik |
| **Deskripsi** | Actor melihat daftar riwayat transaksi yang telah dilakukan |
| **Exception** | - |
| **Precondition** | Actor telah login ke dalam sistem |
...
| Post Condition |
|----------------|
| Actor telah melihat riwayat transaksi sesuai dengan kriteria yang dipilih |
...
| **Aktor** | Admin dan Pemilik |
| **Deskripsi** | Actor dapat melihat laporan penjualan, laporan stok, dan laporan produk terlaris serta mengekspornya ke format PDF atau Excel |
| **Exception** | Gagal menampilkan laporan karena data tidak tersedia atau gagal export |
| **Precondition** | Actor telah login ke dalam sistem dan terdapat data transaksi atau stok yang tersimpan |
...
| Post Condition |
|----------------|
| Actor berhasil melihat laporan dan dapat mengekspornya ke PDF atau Excel |
...
| **ID Use Case** | UC-18 |
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan pengolahan data user pengguna sistem |
...
| 3. Actor memilih tombol untuk mengelola user |
| * Actor memilih Tambah, maka S1 yang berlaku |
| * Actor memilih Edit, maka S2 yang berlaku |
| * Actor memilih Hapus, maka S3 yang berlaku |
...
| 7. Actor kembali menginput data user |
...
| Post Condition |
|----------------|
| Actor berhasil melakukan pengolahan data user |
...
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan pengelolaan role dan hak akses (permission) untuk setiap role dalam sistem |
...
| **ID Use Case** | UC-21 |
| **Aktor** | Admin |
| **Deskripsi** | Actor melakukan pengaturan konfigurasi toko seperti nama toko, alamat, logo, dan nomor telepon |
...
| **ID Use Case** | UC-22 |
| **Aktor** | Admin dan Pemilik |
| **Deskripsi** | Actor dapat memperbarui data profil pengguna seperti nama dan email |
...
| **ID Use Case** | UC-23 |
| **Aktor** | Admin dan Pemilik |
| **Deskripsi** | Actor melakukan penggantian password akun untuk keamanan |
...
Activity diagram login menggambarkan alur autentikasi admin ke dalam sistem.
