                    ...
                    <div class="space-y-8">
                        ...
                        <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                            <div class="mb-6">
                                ...
                                <flux:subheading>{{ __('Enter customer name for this transaction.') }}</flux:subheading>
                            </div>
                        ...
                        <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                            ...
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                @forelse ($this->products as $product)
                                    <div
                                        class="flex items-center justify-between rounded-lg border border-zinc-200 p-3 transition hover:border-zinc-400 dark:border-zinc-700 dark:hover:border-zinc-500">
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate text-sm font-medium">{{ $product->name }}</p>
                                            <p class="text-xs text-zinc-500">
                                                {{ Number::currency($product->price, 'IDR', 'id') }}</p>
                                            @if ($product->stock < 1)
                                                <flux:badge size="xs" color="red" inset="top bottom">out of stock
                                                </flux:badge>
                                            @elseif ($product->stock <= 5)
                                                <flux:badge size="xs" color="orange" inset="top bottom">
                                                    {{ $product->stock }} left</flux:badge>
                                            @endif
                                        </div>
                            ...
                            @if (count($this->cart) > 0)
                                <div class="overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-700">
                                    <table class="w-full text-sm">
                                                ...
                                                <tr class="border-b border-zinc-100 last:border-b-0 dark:border-zinc-800">
                                                    ...
                                                    <td class="px-3 py-2">
                                                        <div class="flex items-center justify-center gap-1">
                                                            ...
                                                            <span
                                                                class="mx-2 min-w-[1.5rem] text-center font-medium">{{ $item['quantity'] }}</span>
                                        ...
                                        <tfoot>
                                            <tr
                                                class="border-t bg-zinc-50 font-semibold dark:border-zinc-700 dark:bg-zinc-800">
                                                <td colspan="3" class="px-3 py-2 text-right">Total</td>
                                                <td class="px-3 py-2 text-right">
                                                    {{ Number::currency($this->totalAmount, 'IDR', 'id') }}</td>
                                                <td></td>
                                            </tr>
                                        </tfoot>
                                    </table>
